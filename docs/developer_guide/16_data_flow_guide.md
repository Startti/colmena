...
Tampoco las llena el estado global (en un hijo, el input del padre), salvo
...
- **`$attachment:<document_id>`** — envío de adjuntos por referencia a endpoints HTTP sin que el LLM vea los bytes. Ver [31_load_attachment.md](./31_load_attachment.md).
