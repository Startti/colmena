    ...
    async fn execute_inner(
        ...
        // scope for the router task.
        {
            use crate::dag_engine::infrastructure::nodes::llm_synthetic_tools::{
                ...
                dispatch_gdocs_format_table, dispatch_gdocs_insert_after_text,
                dispatch_gdocs_insert_before_text, dispatch_gdocs_insert_between,
                dispatch_gdocs_insert_image_after_text, dispatch_gdocs_insert_table_column,
                dispatch_gdocs_insert_table_row, dispatch_gdocs_list_comments,
                dispatch_gdocs_list_named_ranges, dispatch_gdocs_list_permissions,
                dispatch_gdocs_list_tabs, dispatch_gdocs_read_as_markdown,
                dispatch_gdocs_read_outline, dispatch_gdocs_read_tables,
                dispatch_gdocs_replace_named_range, dispatch_gdocs_replace_section,
                dispatch_gdocs_replace_text, dispatch_gdocs_resolve_comment,
                dispatch_gdocs_set_table_cell, dispatch_gdocs_share, dispatch_gdocs_style_text,
                dispatch_gdocs_unshare, GDOCS_ACKNOWLEDGE_HUMAN_CHANGES_TOOL,
                GDOCS_ADD_COMMENT_TOOL, GDOCS_ADD_TAB_TOOL, GDOCS_APPEND_MARKDOWN_TOOL,
                GDOCS_APPLY_EDITS_TOOL, GDOCS_CREATE_FROM_DOCX_TOOL,
                ...
                GDOCS_DELETE_TEXT_TOOL, GDOCS_EXPORT_TOOL, GDOCS_FORMAT_TABLE_TOOL,
                GDOCS_INSERT_AFTER_TEXT_TOOL, GDOCS_INSERT_BEFORE_TEXT_TOOL,
                GDOCS_INSERT_BETWEEN_TOOL, GDOCS_INSERT_IMAGE_AFTER_TEXT_TOOL,
                GDOCS_INSERT_TABLE_COLUMN_TOOL, GDOCS_INSERT_TABLE_ROW_TOOL,
                GDOCS_LIST_COMMENTS_TOOL, GDOCS_LIST_DOCUMENTS_TOOL, GDOCS_LIST_NAMED_RANGES_TOOL,
                GDOCS_LIST_PERMISSIONS_TOOL, GDOCS_LIST_TABS_TOOL, GDOCS_READ_AS_MARKDOWN_TOOL,
                GDOCS_READ_OUTLINE_TOOL, GDOCS_READ_TABLES_TOOL, GDOCS_REPLACE_NAMED_RANGE_TOOL,
                GDOCS_REPLACE_SECTION_TOOL, GDOCS_REPLACE_TEXT_TOOL, GDOCS_RESOLVE_COMMENT_TOOL,
                GDOCS_SET_TABLE_CELL_TOOL, GDOCS_SHARE_TOOL, GDOCS_STYLE_TEXT_TOOL,
                GDOCS_UNSHARE_TOOL,
            };
