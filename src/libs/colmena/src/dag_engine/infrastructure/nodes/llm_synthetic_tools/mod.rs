...
pub use gdocs_tools::{
    ...
    tool_resolve_comment as gdocs_tool_resolve_comment, tool_share as gdocs_tool_share,
    ...
    TOOL_RESOLVE_COMMENT as GDOCS_RESOLVE_COMMENT_TOOL, TOOL_SHARE as GDOCS_SHARE_TOOL,
