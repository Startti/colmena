...
pub struct ToolConfiguration {
    ...
    /// Unified schema defining all fields: fixed values, required params, optional params, types, patterns
    /// This is the recommended way to configure tool parameters.
    #[serde(skip_serializing_if = "Option::is_none", default)]
